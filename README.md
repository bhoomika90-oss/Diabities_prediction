...
Logistic Regression algorithm is used to train the model and perform predictions.
...
7. Web-based prediction using Flask application

OUTPUT
The system predicts whether the patient is:
- Diabetic
- Non-Diabetic
